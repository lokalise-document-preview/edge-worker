...
```
Send POST to http://127.0.0.1:8787/fetch-preview
JSON payload: {
     "apiToken": "85403f7c1a282db62c3f70ff9d0781cd135f181c",
     "projectId": "98763939610c2682dec7e5.55978543",
     "filename": "NL_sample_%LANG_ISO%.html",
     "fileformat": "html",
     "langIso": "de"
}

Response: upacked file for rendering an HTML preview
```
